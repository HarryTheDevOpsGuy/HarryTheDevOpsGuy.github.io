...
---
 ...
 <style>
    ...
    .highlight { background-color: #ffeb3b; transition: background-color 1s ease; }
    ...
    .example-card { cursor: pointer; transition: transform 0.2s; border: 1px solid #e9ecef; border-radius: 10px; padding: 15px; margin-bottom: 15px; }
