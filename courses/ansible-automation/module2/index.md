---
layout: course
title: Module 2 - Working with Playbooks
...
## Lessons
1. [YAML Essentials](yaml-essentials.html)
   - YAML syntax overview
   - Data types and structures
   - Common YAML patterns

2. [Writing Playbooks](writing-playbooks.html)
   - Playbook structure
   - Tasks and modules
   - Handlers and notifications

3. [Variables and Facts](variables-facts.html)
