---
layout: post
title: "GitOps-Driven Kubernetes Platform Engineering with ArgoCD and Crossplane"
date: 2025-06-11
author: Harry The DevOps Guy
tags: [GitOps, ArgoCD, Crossplane, Kubernetes, PlatformEngineering, InfrastructureAsCode, DevOpsTrends, MultiCloud]
...
1. Platform team defines `CompositeResourceDefinition` (XRD) like XPostgresInstance
2. Dev team submits a new claim for a database by committing a `PostgresClaim.yaml` to Git
3. ArgoCD detects the change and syncs it to the cluster
4. Crossplane provisions a new PostgreSQL DB (RDS on AWS or CloudSQL on GCP)
5. Application is deployed via Helm, referencing that DB
